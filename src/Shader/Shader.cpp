...
void Shader::setUniform1iv(const std::string& name, const std::vector<int>& values)
{
    GLCall(glUniform1iv(getUniformLocation(name), static_cast<GLsizei>(values.size()), values.data()));
}
